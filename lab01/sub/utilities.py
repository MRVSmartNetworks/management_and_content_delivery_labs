...
def plotConfInter(metric_name, n_iter, conf_level, intervals, metric_cf_mean, arr_t_list):
    plt.figure()
    plt.title(f"Confidence intervals for {metric_name} - df={n_iter-1} - conf_level={conf_level}")
